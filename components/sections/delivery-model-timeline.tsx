...
function StepCard({ step, align }: { step: DeliveryStep; align: TimelineSide }) {
  ...
  return (
    ...
    >
      <div className="absolute -inset-2 rounded-3xl bg-linear-to-r from-fuchsia-500/10 via-primary/15 to-emerald-500/10 blur-2xl" />
      <div className="relative rounded-2xl border border-border/35 bg-background/35 p-5 shadow-[0_1px_0_0_hsl(var(--foreground)/0.06)_inset,0_12px_40px_-20px_rgba(0,0,0,0.45)] backdrop-blur-md">
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 mask-[linear-gradient(to_bottom,transparent,black_18%,black)]">
          <div className="absolute left-1/2 top-4 h-[30rem] w-[55rem] -translate-x-1/2 rounded-full bg-primary/18 blur-3xl" />
          <div className="absolute left-1/2 top-24 h-[22rem] w-[44rem] -translate-x-1/2 rounded-full bg-fuchsia-500/12 blur-3xl" />
          <div className="absolute left-1/2 top-44 h-[18rem] w-[38rem] -translate-x-1/2 rounded-full bg-emerald-500/10 blur-3xl" />
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div ref={containerRef} className="relative mx-auto mt-14 max-w-5xl">
          ...
          >
            {/* base line */}
            <div className="absolute inset-0 w-[2px] bg-linear-to-b from-transparent via-primary/30 to-transparent [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]" />
            {/* tracing line */}
            <motion.div
              style={{ height: heightTransform, opacity: opacityTransform }}
              className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-b from-fuchsia-300 via-[#d86dfc] to-transparent"
            />
            {/* head glow */}
            <motion.div
          ...
          <div
            ...
            className="absolute left-5 top-0 lg:hidden"
          >
            <div className="absolute inset-0 w-[2px] bg-linear-to-b from-transparent via-primary/25 to-transparent [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]" />
            <motion.div
              style={{ height: heightTransform, opacity: opacityTransform }}
              className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-b from-fuchsia-300 via-[#d86dfc] to-transparent"
            />
