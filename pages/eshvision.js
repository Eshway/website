...
const EshVision = () => {
  ...
  const list = ['likhitha', 'eshller', 'vallabh', 'akshat', 'nakshita', 'admin', 'nashrasabiralisiddiqui', 'vedantbhosale', 'anitarawat', 'chandershekhar', 'ramkumarr', 'harshamge', 'yashkumar', 'akrativerma', 'qunutikhtiyarshirgaonkar', 'shaikhtehreemirshadahmed', 'dhruvsudan', 'aasthaagrawal', 'tarunkurapaty', 'yashasore', 'rohitbenjamine', 'ripankamila', 'suhanirathore', 'gunjangupta', 
  'shashwattrivedi', 'atharvavarpe', 'astitvaraj', 'aniruddhsharma', 'akshikajain', 'lucky@6386752877', 'yuvrajgupta', 'ayushlodhi', 'mradulsonkar', 'ayushtayal', 'raviraj', 'rounakgupta', 'aakashgupta', 'ashishchanel', 'abhaychandra', 'sandhyabarathik', 'lohithreddypolu', 'riteshkumar', 'sahilravindrapatil', 'sumantripathi', 'teena', 'samanthmartis', 'ayushlonakadi', 'ashwinanand',
  'mohammadsamiuddinshafi', 'nikhilsaini', 'rishibhande', 'prajyot', 'ayushnema', 'somannagariananditha', 'omnunase', 'mayureshudaykathe', 'gowrisaieekshithasomisetty', 'nisha', 'amanverma', 'anujyadav', 'shrutisingh', 'jyotiprakash', 'nileshverma', 'rudrapratapsingh', 
  'anshumishra', 'dhruvchaturvedi', 'aryankashyap', 'eekshithasomisetty', 'taiabansary', 'k.sricharanraj', 'yashitkumar', 'purna', 'shaikawezmehtab', 'malaykedia', 'tusharkumarjain', 'shashankjoshi', 'anirudhmamgain', 'rupeshanilsonawane', 'shubhamjoshu', 'polipallimadhusudanarao', 'mohankrishnakatta', 'nikhilnarera', 'shreyassingh', 'harishkumarlaxmikantgajakosh', 'sanyamsingh', 'ronakgupta', 'priyanshusengar', 'divyanshsharma', 'ashwinisinghtomar', 'aaryakokate', 'leelalaharimalla', 'mohiboddinshaikh', 'ashasingh'];
