        ...
        /> */}
                ...
                >
                    ...
                    <div className="mt-[31px] flex flex-col max-w-[370px] gap-[24px]">
                        ...
                        <Link href="https://forms.gle/wUXdw4nRxo41mYDe7" target="_blank" rel="noopener noreferrer"><button className="w-[100%] p-2 text-white bg-[#323f5d]" variant="contained">Buy Now ₹{price}</button></Link>
                    </div>
                </motion.div>
            </motion.div>
        </section>
